...
import {
    ...
    LAUNCH_PARAMETERS,
    SELENOID_OPTIONS, TEST_RUN_PATH, BROWSER_OPTIONS, CAPABILITIES
} from "./common/LaunchParameters.ts";
import {
    BROWSER_DEFAULT_TIMEOUTS,
    CONNECTION_RETRY_TIMEOUT,
    SELENOID_SESSION_TIMEOUTS,
    WAIT_FOR_TIMEOUT,
...
export const config: Options.Testrunner = {
    ...
    //
    hostname: REMOTE_CONNECTION_OPTIONS.HOST_NAME,
    port: REMOTE_CONNECTION_OPTIONS.PORT,
    path: REMOTE_CONNECTION_OPTIONS.PATH,
    //
    // ==================
    // Specify Test Files
    // ==================
    ...
    mochaOpts: {
        ui: 'bdd',
        timeout: BROWSER_DEFAULT_TIMEOUTS
    },
    //
    // =====
    // Hooks
